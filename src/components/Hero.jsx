...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-gradient-to-b from-[#0b0f13] via-[#07080a] to-black text-white min-h-screen'>
