...
const AiTools = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24 bg-gradient-to-b from-[#0b0f13] via-[#07080a] to-black text-white'>
      ...
      <div className='flex flex-wrap mt-10 justify-center'>
        {AiToolsData.map((tool, index)=>( 
            <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#0f1720] shadow-lg border border-gray-800 hover:-translate-y-1 transition-all duration-300 cursor-pointer' onClick={()=> user && navigate(tool.path)}>
